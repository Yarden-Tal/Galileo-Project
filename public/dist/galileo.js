...
var moon = new Planet("Moon", 384.4, "Moon Expedition", 154, 797, "./images/pngfind.com-full-moon-png-319821.png");
...
var imageSrc = document
    .querySelector(".planetPic__image")
    .getAttribute(" src");
...
var changePlanet = function (planetChoice) {
    try {
        ...
        distanceFromEarth.innerHTML =
            planet.distanceFromEarth.toString() + " million km";
        ...
        document
            .querySelector(".planetPic__image")
            .setAttribute("src", planet.imageSrc);
    }
    catch (error) {
        console.error(error);
    }
...
var expDate;
var handleBooking = function (event) {
    try {
        event.preventDefault();
        expDate = event.target.elements.date.value;
